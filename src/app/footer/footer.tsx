export default function Footer() {
    ...
    const linkedinUrl = 'https://www.linkedin.com/in/rohan-erasala';
    const email = 'rerasala@gmail.com';
    ...
    return(
        <>
            ...
            <footer className="footer flex justify-center items-center text-white py-4 w3-animate-opacity-delay-2">
                <a className="icon mx-4" href={linkedinUrl} target="_blank" rel="noopener noreferrer">
                ...
                <a className="icon mx-4" href={`mailto:${email}`}>
