...
export default function NewTimeline() {
    return (
        <>
            <div id = "about" className="container mt-10 mx-auto p-0 sm:p-4 md:p-0 flex flex-row flex-wrap justify-center gap-12 w3-animate-opacity-delay">
            <div className="container">
            <h2 className='text-2xl font-semibold text-center'>About</h2>
            </div>
            <div className="mr-0 max-w-sm">
                <h3 className="mb-10 font-medium text-center">History</h3>
            ...
            <h3 className="mb-10 font-medium">Interests</h3>
            <div className="container text-center max-w-50 grid grid-rows-2 grid-cols-2 gap-8 mb-10 px-8 md:p-0">
                ...
                <div className="bg-gradient-to-r from-teal-300 to-emerald-500 w-50 text-center flex flex-col justify-center rounded-xl p-5">
                    <div className="text-center">
                ...
                <div className="bg-gradient-to-r from-yellow-300 to-amber-500 w-50 text-center flex flex-col justify-center rounded-xl p-5">
                    <div className="text-center">
